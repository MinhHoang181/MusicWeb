...
<div class="container">
  <h2 class="text-info"><a href="index.php?menu=singerdata" class="text-dark"><i class="fa fa-arrow-left"></i></a>  Thêm ca sĩ</h2>
  <hr>
	...
	<div class="row">
      ...
      <div class="col-md-9 personal-info">
        <!-- thong bao-->
          ...
          <?php 
          } else if (isset($_SESSION["create_fail"])) { 
          ?>
        ...
        <!-- form edit-->
        <form id="addForm" action="system/music.php" method="POST" enctype="multipart/form-data">
          <!-- name -->
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <textarea class="form-control" name="info" style="height: 250px"></textarea>
            </div>
				  </div>
          <!-- nation -->
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <div class="ui-select">
                <select id="nation" class="form-control" name="nation">
                  ...
                  <option value="Hoa Ngữ">Hoa Ngữ</option>
                  <option value="Hoà Tấu">Hoà Tấu</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <!-- button submit -->
          <button type="submit" class="btn btn-secondary btn-lg ml-3" name="addSingerBtn" id="addSingerBtn">Thêm ca sĩ</button>
        </form>
        <!--/.form edit -->
      </div>
  </div>
