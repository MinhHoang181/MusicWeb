function createAudioPlayer() {
    ...
    //   playButton.className = ('col-md-2');
      playButton.innerHTML = '<i class="fa fa-play" onclick="myFunction()"aria-hidden="true"></i>';
      playButton.ariaLabel = 'Play';
      playButton.onclick = play;
      var pauseButton = document.createElement('button');
      pauseButton.id = ('btn_pause');
    //   pauseButton.className = ('col-md-2');
      ...
      informationDiv.className = 'audio-player-info text-md-center';
      ...
      progressmeter.className = 'audio-player-progressmeter audio-player-info';
